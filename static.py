...
# ---------------------------------------------------------
COLOUR = transform.scale(image.load("static/side_icons/colour.png"), (32, 32))
OPACITY = transform.scale(image.load("static/side_icons/opacity.png"), (32, 32))
WIDTH = transform.scale(image.load("static/side_icons/width.png"), (32, 32))
...
UNDO = transform.scale(image.load("static/side_icons/undo.png"), (32, 32))
